...
public enum StringUtils {
    ...
    /**
     * Generates a String of length specified. The generated String is guaranteed to contain 
     * only special chars as defined by {@link SpecialChar} 
     ...
     * check for the String length of object to be appended, and is assumed to be 1. 
     * The String value of the passed object will be appended if {@link StringUtils#canAppend(StringBuilder)}
     * return <code>True</code>
     * @param target StringBuilder to which the object is to be appended
     * @param c object to be appended
     ...
     * @param target StringBuilder to be checked
     * @return <code>True</code> if the target can contain one more <code>char</code>, <False> otherwise.
     */
