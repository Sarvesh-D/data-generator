...
public class FakerGeneratorTest {
    ...
    private static String[] fakerLocales = { "ca", "ca-CAT", "da-DK", "de", "de-AT", "de-CH", "en", "en-AU", "en-au-ocker", "en-BORK", "en-CA", "en-GB", "en-IND", "en-NEP", "en-NG", "en-NZ", "en-PAK",
            "en-SG", "en-UG", "en-US", "en-ZA", "es", "es-MX", "fa", "fi-FI", "fr", "he", "in-ID", "it", "ja", "ko", "nb-NO", "nl", "pl", "pt", "pt-BR", "ru", "sk", "sv", "sv-SE", "tr", "uk", "vi",
            "zh-CN", "zh-TW" };

    private static void doTest() {
        final Faker faker = new Faker();
        final String data = faker.resolve(getFakerKey());
