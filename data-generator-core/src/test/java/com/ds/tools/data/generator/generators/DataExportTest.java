...
public class DataExportTest {
    ...
    public final void testDataExportFromCmdQuery() {
        ...
        try {
            ...
            assertTrue("Quantity of data in csv file should be 101 including csv header", reader.readAll()
                                                                                                .size() == 101);
    ...
    public final void testMultipleValidQueriesWithExport() {
        ...
        final Path exportFile2 = Paths.get("stringQueryWExport_2.csv");
