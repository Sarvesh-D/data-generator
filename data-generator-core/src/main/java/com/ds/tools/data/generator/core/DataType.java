...
public enum DataType implements Identifier<Character>, CMDLineArgHelper {
    ...
    /**
     * Number Type. The Digits in Number generated will have Properties as defined
     * by {@link NumberProperties}
     *
    ...
    /**
     * Returns the {@link DataType} which is identified by the identifier passed. If
     * there is not dataType for the passed identifier <code>Null</code> is returned
     *
     * @param identifier
     *            for which dataType is required.
     * @return {@link DataType} for the identifier.
     */
    public static DataType of(final char identifier) {
