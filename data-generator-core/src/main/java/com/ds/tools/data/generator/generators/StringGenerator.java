...
public class StringGenerator implements Generator<String> {
     ...
     */
    public static StringGenerator of(final StringType stringType) {
    ...
    public String generate() {
         ...
         */
        final StringBuilder baseString = new StringBuilder(stringType.getLength());
        final StringJoiner finalString = new StringJoiner(Constants.EMPTY_STRING, org.apache.commons.lang3.StringUtils.trimToEmpty(stringType.getPrefix()), org.apache.commons.lang3.StringUtils.trimToEmpty(stringType.getSuffix()));
        while (StringUtils.canAppend(baseString)) {
            stringType.getProperties()
                      .stream()
                      .forEach(property -> StringUtils.append(baseString, property.getGenerator()
                                                                                  .generate()));
        }
