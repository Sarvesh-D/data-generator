...
/**
 * Implementation for interpreting details of {@link FakerType} from identifiers.
 * 
...
class FakerTypeInterpreter extends AbstractTypeInterpreter {
	...
	Optional<Object> key = fakerProps.stream().filter(prop -> StringUtils.contains(prop.toString(), ".")).findFirst();
